...
const faqs = [
  ...
  { q: '¿Por qué es mensual y no un pago único?', a: 'Porque Sentinel no es un software que se instala y queda quieto. Cada mes lo monitoreamos, lo mejoramos y lo ajustamos con las conversaciones reales de tu negocio. Es un empleado que aprende, no un bot que envejece. La implementación está bonificada durante el período de lanzamiento.' },
