        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col gap-6 lg:col-span-5 pr-0 lg:pr-12">
            ...
            <div className="flex gap-5 mt-4">
              <a href="https://www.instagram.com/scalaops/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#111] border border-[#222] flex items-center justify-center text-[#6bdda1] hover:bg-[#6bdda1] hover:text-black transition-all">
              ...
              <a href="https://www.linkedin.com/company/scalaops" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#111] border border-[#222] flex items-center justify-center text-[#6bdda1] hover:bg-[#6bdda1] hover:text-black transition-all">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
              <a href="https://wa.link/sn01qs" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#111] border border-[#222] flex items-center justify-center text-[#6bdda1] hover:bg-[#6bdda1] hover:text-black transition-all">
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            <a href="https://wa.link/sn01qs" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 text-[14px] text-[#999999] hover:text-[#185de8] transition-colors font-medium" style={{ fontFamily: 'var(--font-secondary)' }}>
              WhatsApp directo
            </a>
            
            <a href="https://www.linkedin.com/company/scalaops" target="_blank" rel="noopener noreferrer" className="text-[14px] text-[#999999] hover:text-[#185de8] transition-colors font-medium" style={{ fontFamily: 'var(--font-secondary)' }}>
              LinkedIn
            </a>
          </div>
