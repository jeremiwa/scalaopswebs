...
export const HeroInstitutional = () => {
  ...
  return (
    <section className="relative w-full min-h-[95vh] flex items-center bg-[#000000] overflow-hidden pt-20">
      ...
      <div className="hidden lg:flex absolute top-1/2 right-0 -translate-y-1/2 w-[45vw] h-[80%] flex-col justify-center gap-[60px] select-none pointer-events-none z-10 overflow-hidden">
        {bars.map((bar, i) => (
