...
export const CtaFinal = () => {
  return (
    <section className="relative" style={{ background: '#000000', padding: '120px 0 80px' }}>
      <div style={{ position: 'absolute', top: '-80px', left: '-100px', right: '-100px', bottom: '-80px', zIndex: 0, pointerEvents: 'none', borderRadius: '80px', background: 'radial-gradient(ellipse at 50% 60%, rgba(107, 221, 161,0.07) 0%, rgba(107, 221, 161,0.02) 40%, transparent 65%)', filter: 'blur(120px)', transform: 'translateZ(0)' }}></div>
      {/* Dot grid pattern */}
      ...
      <div className="container-custom relative z-10 flex flex-col items-center text-center">
        <div className="max-w-[700px] mx-auto reveal">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            <span className="w-2.5 h-2.5 rounded-full bg-[#6bdda1] animate-pulse shadow-[0_0_6px_#6bdda1]"></span>
          ...
          <div className="mt-8 text-[13px] flex flex-wrap justify-center items-center gap-x-6 gap-y-3 font-medium" style={{ color: 'rgba(203,213,225,0.68)' }}>
            <span className="flex items-center gap-1.5"><span className="text-[#6bdda1]">✓</span> Llamada sin costo</span>
            <span className="hidden md:block w-1 h-1 rounded-full bg-white/10"></span>
            <span className="flex items-center gap-1.5"><span className="text-[#6bdda1]">✓</span> Resultados en 72hs</span>
            <span className="hidden md:block w-1 h-1 rounded-full bg-white/10"></span>
            <span className="flex items-center gap-1.5"><span className="text-[#6bdda1]">✓</span> Sin permanencia</span>
          </div>

          <div className="mt-10">
            <a href="https://wa.link/sn01qs" target="_blank" rel="noopener noreferrer" className="text-[14px] hover:text-[#6bdda1] transition-colors border-b border-transparent hover:border-[#6bdda1] pb-0.5 inline-flex flex-col md:flex-row items-center gap-1" style={{ color: 'rgba(203,213,225,0.60)' }}>
