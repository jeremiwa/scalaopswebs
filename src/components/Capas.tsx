...
export const Capas = () => {
    return (
        <section className="py-[140px] relative bg-[#0A0A0F]">
            {/* #2 — Blue glow from top */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1000px] h-[400px] pointer-events-none" style={{ background: 'radial-gradient(ellipse at center top, rgba(59,130,246,0.03) 0%, transparent 70%)' }}></div>
            ...
            <div className="container-custom relative z-10 flex flex-col items-center text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl reveal-stagger text-left">
                    {/* Capa 1 — opacity 0.3 */}
                    <div className="rounded-[17px] p-[1px] bg-gradient-to-b from-white/[0.08] to-white/[0.02] hover:from-[#22C55E]/40 hover:to-[#22C55E]/5 transition-all duration-500">
                        <div className="bg-[#111116] rounded-[16px] p-8 relative group h-full">
                            <div className="w-full h-[3px] absolute top-0 left-0 bg-[#22C55E]/30 rounded-t-[16px]"></div>
                            <LayoutGrid size={36} strokeWidth={1.5} className="text-[#22C55E] mb-5 capa-icon" />
                    ...
                    <div className="rounded-[17px] p-[1px] bg-gradient-to-b from-white/[0.08] to-white/[0.02] hover:from-[#22C55E]/40 hover:to-[#22C55E]/5 transition-all duration-500 md:transform md:-translate-y-2">
                        <div className="bg-[#111116] rounded-[16px] p-8 relative group h-full">
                            <div className="w-full h-[3px] absolute top-0 left-0 bg-[#22C55E]/50 rounded-t-[16px]"></div>
                            <MessageSquareText size={36} strokeWidth={1.5} className="text-[#22C55E] mb-5 capa-icon" />
                    ...
                    <div className="rounded-[17px] p-[1px] bg-gradient-to-b from-white/[0.08] to-white/[0.02] hover:from-[#22C55E]/40 hover:to-[#22C55E]/5 transition-all duration-500">
                        <div className="bg-[#111116] rounded-[16px] p-8 relative group h-full">
                            <div className="w-full h-[3px] absolute top-0 left-0 bg-[#22C55E]/70 rounded-t-[16px]"></div>
                            <BarChart3 size={36} strokeWidth={1.5} className="text-[#22C55E] mb-5 capa-icon" />
